...
@class DTXProxyChannel, NSString, NSUUID, XCTProtocolVersion;
@protocol OS_dispatch_queue, XCTDebugLogDelegate, XCTTransportProvider, XCTestManager_DaemonConnectionInterface;
