...
- (id)operationWithWorkingDirectory:(id)arg1 workspaceFilePath:(id)arg2 projectFilePath:(id)arg3 buildSchemeAction:(id)arg4 outError:(id *)arg5;
- (id)customExecutableToSelectForBuildSchemeAction:(id)arg1;
- (id)pathsForAllBuildablesInSchemeMatchingPredicate:(CDUnknownBlockType)arg1 buildEntryPredicate:(CDUnknownBlockType)arg2 buildSchemeAction:(id)arg3;
...
- (id)pathsForBuildables:(id)arg1 buildSchemeAction:(id)arg2;
