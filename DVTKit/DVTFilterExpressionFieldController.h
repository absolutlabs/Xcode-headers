...
@class DVTFilterExpression, DVTFilterExpressionController, NSMutableDictionary, NSMutableSet;
...
@interface DVTFilterExpressionFieldController : DVTFilterTokenBasedFieldController
{
    ...
    DVTFilterExpression *_currentFilterExpression;
...
@property(retain) DVTFilterExpression *currentFilterExpression; // @synthesize currentFilterExpression=_currentFilterExpression;
- (void).cxx_destruct;
