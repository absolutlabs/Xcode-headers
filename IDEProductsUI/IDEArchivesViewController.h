...
@class DVTBorderedView, DVTDelayedInvocation, DVTNotificationToken, DVTObservingToken, DVTTableView, IDESearchFilterControlBar, NSAlert, NSArray, NSArrayController, NSImage, NSString, NSTableHeaderView, NSTextField, NSView;
@protocol IDEProductsInspectable;

@interface IDEArchivesViewController : IDEViewController <IDEFilterControlBarTarget, NSTableViewDelegate, DVTTableCellViewTitleEditingDelegate, IDEInitialization, DVTTableRowViewMouseInsideDelegate, IDEProductsInspectableVending>
{
