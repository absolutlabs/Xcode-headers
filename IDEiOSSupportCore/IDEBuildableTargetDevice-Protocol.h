...
@class DVTFilePath, DVTOperation, IDEBuildParameters, IDEBuildSchemeAction, IDELaunchSession, IDEOverridingBuildProperties, IDEScheme, IDEWorkspace, NSArray, NSDictionary, NSString;
@protocol IDEAnalysisToolService, IDEBuildable;

@protocol IDEBuildableTargetDevice <DVTBasicDevice>
- (DVTOperation *)analysisOperationWithAnalysisToolService:(id <IDEAnalysisToolService>)arg1 location:(id)arg2 workingDirectory:(DVTFilePath *)arg3 workspaceFilePath:(DVTFilePath *)arg4 projectFilePath:(DVTFilePath *)arg5 buildSchemeAction:(IDEBuildSchemeAction *)arg6 outError:(id *)arg7;
