...
@class DVTBorderedView, GPUDependencyMetalView, GPUGVGraph, GPUTextureClipView, GPUTraceSKScene, NSMutableDictionary, NSProgressIndicator, NSScrollView, NSSegmentedControl, NSString, NSTextField, NSView, SKCameraNode, SKNode, SKView;
...
@property(nonatomic) __weak SKView *skView; // @synthesize skView;
- (void).cxx_destruct;
