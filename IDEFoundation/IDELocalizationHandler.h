...
@class DVTStackBacktrace, IDEBuildParameters, IDEContainer, IDEWorkspace, LOCHandler, NSArray, NSDictionary, NSSet, NSString, NSUUID;
...
- (id)initWithWorkspace:(id)arg1 buildParameters:(id)arg2 container:(id)arg3 options:(id)arg4 sourceLanguage:(id)arg5;
