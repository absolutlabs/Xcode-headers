...
@interface IDETestRunSession : NSObject <IDETestsActivityLogBuilderDelegate, IDETestTargetRunnerEvents, IDETestsInTestableObserver, DVTProgressReporting, DVTInvalidation>
{
