...
@protocol IDEBuildableProduct, IDETestDaemonController, IDETestRunnerEvents, OS_dispatch_queue;
...
- (id)initWithTestRunSpecification:(id)arg1 executionEnvironment:(id)arg2 runDestination:(id)arg3 launchParametersBlock:(CDUnknownBlockType)arg4 artifactsDirectory:(id)arg5 daemonController:(id)arg6;
- (id)init;
