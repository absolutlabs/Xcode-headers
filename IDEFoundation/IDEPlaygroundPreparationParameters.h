...
- (id)initWithExecutablePath:(id)arg1 targetTriple:(id)arg2 sdk:(id)arg3 reuseProcess:(BOOL)arg4 replMode:(BOOL)arg5 device:(id)arg6 playgroundName:(id)arg7 librarySearchPaths:(id)arg8 frameworkSearchPaths:(id)arg9 standardLibraryLocation:(id)arg10 playgroundLoggerLibraryLocation:(id)arg11 lldbLocation:(id)arg12 auxiliarySourceFrameworkLocations:(id)arg13 symlinkedResourcesDirectory:(id)arg14 resourceSearchPaths:(id)arg15 containerPath:(id)arg16;
