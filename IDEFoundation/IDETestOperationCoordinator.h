...
@class DVTDevice, DVTDisallowFinishToken, DVTObservingToken, DVTOperation, DVTStackBacktrace, IDELaunchSessionEventSource, IDERunOperation, IDETestOperationEventSource, IDETestOperationStateMachine, IDETestOutputProcessor, IDETestRunner, IDETestingDiagnosticLogArbiter, NSDateFormatter, NSMutableArray, NSMutableDictionary, NSMutableSet, NSOutputStream, NSString, NSTimer, NSUUID, XCTTestRunnerSession;
@protocol IDETestDaemonController, IDETestOperationCoordinatorEvents, IDETestingLaunchSession, OS_dispatch_queue, _TtP13IDEFoundation22IDETestingOutputStream_;
...
+ (id)_messageForResult:(BOOL)arg1 diagnosticLogPath:(id)arg2;
...
- (void)logDebugMessage:(id)arg1;
- (void)processDiagnosticReportWithData:(id)arg1 bundleID:(id)arg2 binaryPath:(id)arg3 pid:(int)arg4 crashingSymbol:(id)arg5;
- (void)testDaemonController:(id)arg1 receivedCrashReportWithData:(id)arg2 bundleID:(id)arg3 binaryPath:(id)arg4 pid:(int)arg5 crashingSymbol:(id)arg6;
...
- (id)initWithTestRunOperation:(id)arg1 forTestRunner:(id)arg2 daemonController:(id)arg3;
- (id)initWithDelegate:(id)arg1 forTestRunner:(id)arg2 daemonController:(id)arg3;
