...
@class DVTNotificationToken, IDENavigableItem, IDENavigableItemCoordinator, IDEPathControl, IDESchemeManagerNavigable, IDEWorkspace, IDEWorkspaceTabController, NSString, NSToolbarItem;
