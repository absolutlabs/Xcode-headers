...
@class DVTFilePath, DVTStackBacktrace, IDESourceControlCreateGitRepositoryOperationInfo, IDEWorkspaceDocument, NSAlert, NSMutableSet, NSOperationQueue, NSString;
