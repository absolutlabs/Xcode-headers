...
- (BOOL)ibSwizzledNSView_ibShouldPopulateIssuesForOverlappingViewsInDocument:(id)arg1;
- (void)ibSwizzledNSView_ibPopulateIssues:(id)arg1 forOverlappingViewsForSibling:(id)arg2 withParentView:(id)arg3 inDocument:(id)arg4 withComputationContext:(id)arg5;
