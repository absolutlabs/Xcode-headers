...
@protocol IDEDNTDisplayTreeIndexDelegate;

@interface IDEDNTDisplayTreeIndex : NSObject
{
    NSString *_path;
    ...
    id <IDEDNTDisplayTreeIndexDelegate> _delegate;
}
...
@property(readonly, nonatomic) id <IDEDNTDisplayTreeIndexDelegate> delegate; // @synthesize delegate=_delegate;
