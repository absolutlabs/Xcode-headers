...
- (id)initWithIdentifier:(id)arg1 archivingName:(id)arg2 displayName:(id)arg3 scaleFactor:(double)arg4 preferredSimulatorDeviceType:(id)arg5 idiom:(id)arg6 bezelCornerRadius:(id)arg7 bezelCornerRadiusInset:(id)arg8 adaptations:(id)arg9 defaultOrientation:(id)arg10 defaultAdaptationByOrientationMap:(id)arg11;
