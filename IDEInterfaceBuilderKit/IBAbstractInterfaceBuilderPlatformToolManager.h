...
@interface IBAbstractInterfaceBuilderPlatformToolManager : NSObject <IBAbstractPlatformToolProxyDelegate>
{
    ...
    long long _toolsLaunchingCount;
...
- (void)shutdownToolsExcludingToolDescription:(id)arg1 keepOnePerDevice:(BOOL)arg2;
...
- (long long)toolsLaunchingCount;
- (void)decrementToolsLaunchingCount;
- (void)incrementToolsLaunchingCount;
...
- (void)shutdownLongIdleToolsForToolDescription:(id)arg1;
