...
- (id)createLocalRepositoryAtURL:(id)arg1 authenticationOptions:(unsigned long long)arg2 progressBlock:(CDUnknownBlockType)arg3 completionBlock:(CDUnknownBlockType)arg4;
