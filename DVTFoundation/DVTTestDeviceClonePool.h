...
- (void)cleanUpPreexistingClones:(id)arg1 fromCreator:(id)arg2;
- (void)populatePoolWithPreexistingClones:(id)arg1 fromCreator:(id)arg2;
- (id)initWithCreators:(id)arg1 initializationBehavior:(unsigned long long)arg2 purgePolicy:(unsigned long long)arg3;
